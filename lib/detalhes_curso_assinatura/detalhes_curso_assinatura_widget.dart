...
import 'detalhes_curso_assinatura_model.dart';
export 'detalhes_curso_assinatura_model.dart';
...
class DetalhesCursoAssinaturaWidget extends StatefulWidget {
  const DetalhesCursoAssinaturaWidget({
    super.key,
    required this.curso,
  });
  ...
  static String routeName = 'detalhesCursoAssinatura';
  static String routePath = '/detalhesCursoAssinatura';

  @override
  State<DetalhesCursoAssinaturaWidget> createState() =>
      _DetalhesCursoAssinaturaWidgetState();
}

class _DetalhesCursoAssinaturaWidgetState
    extends State<DetalhesCursoAssinaturaWidget> {
  late DetalhesCursoAssinaturaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesCursoAssinaturaModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      widget.curso?.descricaoAssinatura,
                                      '...',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
