...
export 'push_notifications_model.dart';
...
class _PushNotificationsWidgetState extends State<PushNotificationsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listarPush = await actions.listarPushAgendados();
      _model.listarPush2 = await actions.listaPushAgendados();
    });
