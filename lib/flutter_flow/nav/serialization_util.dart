      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case SurveyQuestionsRow:
            return SurveyQuestionsRow(data);
          case AvaliacoesCursosRow:
            return AvaliacoesCursosRow(data);
          case AulasRow:
            return AulasRow(data);
          case CadastroSocialRow:
            return CadastroSocialRow(data);
          case AcessoresRow:
            return AcessoresRow(data);
          case ApoiadoresPoliticosRow:
            return ApoiadoresPoliticosRow(data);
          case NotificacoesPushRow:
            return NotificacoesPushRow(data);
          case OrcamentoRow:
            return OrcamentoRow(data);
          case SurveyResponsesRow:
            return SurveyResponsesRow(data);
          case BidRow:
            return BidRow(data);
          case PropostasRow:
            return PropostasRow(data);
          case ModulosRow:
            return ModulosRow(data);
          case AdversariosPoliticosRow:
            return AdversariosPoliticosRow(data);
          case DbAtivoRow:
            return DbAtivoRow(data);
          case CategoriasCursosRow:
            return CategoriasCursosRow(data);
          case SloganCampanhaRow:
            return SloganCampanhaRow(data);
          case CursosRow:
            return CursosRow(data);
          case MeusCursosRow:
            return MeusCursosRow(data);
          case MateriaisApoioRow:
            return MateriaisApoioRow(data);
          case SurveysRow:
            return SurveysRow(data);
          case RepresentantesRow:
            return RepresentantesRow(data);
          case AssinaturasRow:
            return AssinaturasRow(data);
          case AgendaRow:
            return AgendaRow(data);
          case PrecosRow:
            return PrecosRow(data);
          case InstituicoesRow:
            return InstituicoesRow(data);
          case UsersRow:
            return UsersRow(data);
          case ProfissoesRow:
            return ProfissoesRow(data);
          case CobrancasRow:
            return CobrancasRow(data);
