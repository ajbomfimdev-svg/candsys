...
import '/components_cand_sys/notificacoes_push/notificacoes_push_widget.dart';
...
import 'lista_notificaes_politico_model.dart';
export 'lista_notificaes_politico_model.dart';

class ListaNotificaesPoliticoWidget extends StatefulWidget {
  const ListaNotificaesPoliticoWidget({super.key});

  @override
  State<ListaNotificaesPoliticoWidget> createState() =>
      _ListaNotificaesPoliticoWidgetState();
}

class _ListaNotificaesPoliticoWidgetState
    extends State<ListaNotificaesPoliticoWidget> {
  late ListaNotificaesPoliticoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaNotificaesPoliticoModel());
                                            ...
                                            Flexible(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    valueOrDefault<String>(
                                                      'Enviada para: ${containerUsersRow?.nome}',
                                                      'Nome',
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
