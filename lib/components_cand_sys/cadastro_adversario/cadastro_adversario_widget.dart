...
import 'cadastro_adversario_model.dart';
export 'cadastro_adversario_model.dart';

class CadastroAdversarioWidget extends StatefulWidget {
  const CadastroAdversarioWidget({super.key});

  @override
  State<CadastroAdversarioWidget> createState() =>
      _CadastroAdversarioWidgetState();
}

class _CadastroAdversarioWidgetState extends State<CadastroAdversarioWidget> {
  late CadastroAdversarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroAdversarioModel());

    _model.nomeCompletoAdversarioTextController ??= TextEditingController();
    _model.nomeCompletoAdversarioFocusNode ??= FocusNode();
    _model.nomeCompletoAdversarioFocusNode!
        .addListener(() => safeSetState(() {}));
    _model.idadeAdversarioTextController ??= TextEditingController();
    ...
    _model.bairroAdversarioTextController ??= TextEditingController();
    _model.bairroAdversarioFocusNode ??= FocusNode();
    _model.bairroAdversarioFocusNode!.addListener(() => safeSetState(() {}));
    _model.obsAdversarioTextController ??= TextEditingController();
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                hintText: 'Estado',
                                searchHintText: 'Pesquisar estado...',
                                searchCursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                icon: Icon(
                                  Icons.keyboard_arrow_down_rounded,
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.dDCidadeValueController ??=
                                            FormFieldController<String>(null),
                                    options: BuscarMunicipiosCall.cidade(
                                      dDCidadeBuscarMunicipiosResponse.jsonBody,
                                    )!,
                                    onChanged: (val) => safeSetState(
                                        () => _model.dDCidadeValue = val),
                                    width:
                                    ...
                                    hintText: 'Selecionar sua cidade...',
                                    searchHintText: 'Pesquisar cidade...',
                                    icon: Icon(
                                      Icons.keyboard_arrow_down_rounded,
                                      color: FlutterFlowTheme.of(context)
                                          .secondaryText,
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        safeSetState(() {
                          _model.nomeCompletoAdversarioTextController?.clear();
                          _model.idadeAdversarioTextController?.clear();
                          _model.processoJudicalTextController?.clear();
                          _model.bairroAdversarioTextController?.clear();
                          _model.obsAdversarioTextController?.clear();
                        });
                        safeSetState(() {
                          _model.partidoValueController?.reset();
                          _model.partidoValue = null;
                          _model.dDFormacaoEscolarValueController?.reset();
                          _model.dDFormacaoEscolarValue = null;
                          _model.dDEstadoCivilValueController?.reset();
                          _model.dDEstadoCivilValue = null;
                          _model.dDExpEleitoralValueController?.reset();
                          _model.dDExpEleitoralValue = null;
                          _model.dDUFAdversarioValueController?.reset();
                          _model.dDUFAdversarioValue = null;
                          _model.dDCidadeValueController?.reset();
                          _model.dDCidadeValue = null;
                          _model.profissaoAdversarioValueController?.reset();
                          _model.profissaoAdversarioValue = null;
                        });
                        Navigator.pop(context);
                      },
                      text: 'Cancelar',
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.dDCidadeValue == null) {
                          return;
                        }
                        await AdversariosPoliticosTable().insert({
                          'nome':
                              _model.nomeCompletoAdversarioTextController.text,
                          'politico_id': valueOrDefault(
                              currentUserDocument?.politicoId, ''),
                          'bairro': _model.bairroAdversarioTextController.text,
                          'cidade': _model.dDCidadeValue,
