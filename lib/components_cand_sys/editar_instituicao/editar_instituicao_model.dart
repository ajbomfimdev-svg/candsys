...
import 'editar_instituicao_widget.dart' show EditarInstituicaoWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class EditarInstituicaoModel extends FlutterFlowModel<EditarInstituicaoWidget> {
  ///  State fields for stateful widgets in this component.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - Query Rows] action in editarInstituicao widget.
  List<InstituicoesRow>? instituicaoCarregada;
  // Stores action output result for [Backend Call - API (Busca endereco pelo CEP)] action in editarInstituicao widget.
  ApiCallResponse? apiResultle8;
  ...
  // State field(s) for RadioButtonAni widget.
  FormFieldController<String>? radioButtonAniValueController;
  ...
  String? get radioButtonAniValue => radioButtonAniValueController?.value;
