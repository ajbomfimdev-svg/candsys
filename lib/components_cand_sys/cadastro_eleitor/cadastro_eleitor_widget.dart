...
import 'cadastro_eleitor_model.dart';
export 'cadastro_eleitor_model.dart';

class CadastroEleitorWidget extends StatefulWidget {
  const CadastroEleitorWidget({super.key});

  @override
  State<CadastroEleitorWidget> createState() => _CadastroEleitorWidgetState();
}

class _CadastroEleitorWidgetState extends State<CadastroEleitorWidget> {
  late CadastroEleitorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroEleitorModel());
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        safeSetState(() {
                          ...
                          _model.bairroApoiadorTextController?.clear();
                          _model.cidadeApoiadorTextController?.clear();
