...
class BrasilTextFieldCentro extends StatefulWidget {
  const BrasilTextFieldCentro({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextFieldCentro> {
  @override
