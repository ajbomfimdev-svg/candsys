...
class BrasilTextField3 extends StatefulWidget {
  const BrasilTextField3({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextField3> {
  @override
