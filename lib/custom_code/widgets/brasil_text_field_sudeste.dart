...
class BrasilTextFieldSudeste extends StatefulWidget {
  const BrasilTextFieldSudeste({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextFieldSudeste> {
  @override
