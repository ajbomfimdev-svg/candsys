...
class BrasilTextFieldNordeste extends StatefulWidget {
  const BrasilTextFieldNordeste({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextFieldNordeste> {
  @override
