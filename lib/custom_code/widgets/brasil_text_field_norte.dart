...
class BrasilTextFieldNorte extends StatefulWidget {
  const BrasilTextFieldNorte({
    Key? key,
    this.width,
    this.height,
    this.value,
...
class _BrasilTextFieldState extends State<BrasilTextFieldNorte> {
  @override
